...
<title>I'MPOSSIBLE - Edit Status</title>
			...
			<div class="page-header">
				<div class="container-fluid">
					...
					<ul class="breadcrumb">
						...
						<li><a href="manageItemStatus.jsp">Manage Item Status</a></li>
					</ul>
				</div>
			</div>
			<div class="container-fluid">
					...
					<div class="panel-body">
						...
						<c:forEach var="iStatus" items="${itemStatus.rows}">
							<form method="post" class="form-horizontal" name="myForm"
								action="editItemStatus">

								<input type="hidden" value="${iStatus.status_id}" name="id"></input>
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<input type="text" name="status_name"
											value="${iStatus.status_name}" placeholder="Status Name"
											id="input-name1" class="form-control" required />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="status_description"
											...
											value="${iStatus.status_desc}" class="form-control" required></input>
