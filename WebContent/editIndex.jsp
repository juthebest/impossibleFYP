...
<sql:query var="a" dataSource="${dataSource}">
 SELECT  * from banner_image where banner_image_id=<%=request.getParameter("id")%>
					...
					<div class="panel-body">
						...
						<form action="FileUploadDBServlet" method="post"
							enctype="multipart/form-data" class="form-horizontal">
								...
								<input type="hidden" name="id" value="${b.banner_image_id}">
