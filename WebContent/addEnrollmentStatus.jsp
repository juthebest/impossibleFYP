...
<title>I'MPOSSIBLE - Add Enrollment Status</title>
			...
			<div class="page-header">
				<div class="container-fluid">
					...
					<ul class="breadcrumb">
						...
						<li><a href="manageEnrollmentStatus.jsp">Status</a></li>
						<li><a href="addEnrollmentStatus.jsp">Add Enrollment Status</a></li>
					</ul>
				</div>
			</div>
			<div class="container-fluid">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="fa fa-pencil"></i>Add Enrollment Status
						</h3>
					</div>
					<div class="panel-body">
						<form method="post" class="form-horizontal" name="myForm"
							action="addEnrollmentStatus">
