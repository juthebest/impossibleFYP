...
<title>I'MPOSSIBLE - Add User Status</title>
				...
				<div class="container-fluid">
					...
					<ul class="breadcrumb">
						...
						<li><a href="manageUserStatus.jsp">Manage User Status</a></li>
							<li><a href="addUserStatus.jsp">addUserStatus</a></li>
					</ul>
				</div>
			</div>
			<div class="container-fluid">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="fa fa-pencil"></i>Add User Status
						</h3>
					</div>
					<div class="panel-body">
						<form method="post" class="form-horizontal" name="myForm"
							action="addUserEnrollment">



							<div class="form-group required">
								<label class="col-sm-2 control-label" for="input-name1">User Status
									Name</label>
								<div class="col-sm-10">
