...
/**
 * Servlet implementation class readImageItem
 */
@WebServlet("/readImageItem")
public class readImageItem extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public readImageItem() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query = "SELECT images, image_type FROM item WHERE item_id  = '"+id+"'";
