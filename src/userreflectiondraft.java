...
/**
 * Servlet implementation class userreflectiondraft
 */
@WebServlet("/userreflectiondraft")
public class userreflectiondraft extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public userreflectiondraft() {
		super();
