	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			while (rs.next()) {
				...
				int a= ustmt.executeUpdate("INSERT INTO `client`(`parent_id`, `client_dob`,`client_school`,  `relationship_to_child`) VALUES ('"+key+"','"+dob+"','"+school+"','"+relationship+"')",Statement.RETURN_GENERATED_KEYS);
